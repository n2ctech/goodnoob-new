...
$(document).ready(function() {
    ...
    */
    ...
    $(document).on('click','.toggle-social-share-popup', function(e){
      e.preventDefault()
      $(this).closest('.thumb-menu-stripe').find('.social_share_popup_group').toggle();
    })
